...
import com.pinecone.summer.prototype.ServiceSystem;
...
public class ArchServiceSystem implements ServiceSystem {
    ...
    public ArchServiceSystem( String szResourcesPath, String szConfigFileName ) throws IOException {
        this.mszResourcesPath = szResourcesPath;
        this.mszConfigPath    = szResourcesPath + szConfigFileName;
        this.construct();
    }

    public ArchServiceSystem( SystemServlet servlet ) throws IOException {
        this.mSystemServlet  = servlet;
        this.mServletContext = this.mSystemServlet.getServletContext();
        this.mszConfigPath   = ArchServiceSystem.getSystemConfigPath(
