...
public class ArchConnectDispatcher implements ConnectDispatcher {
    protected ArchServiceSystem      mArchServiceSystem;
    ...
    public ArchConnectDispatcher( ArchServiceSystem system, RouterType routerType ){
        this.mArchServiceSystem   = system;
        this.mHttpEntityParser = this.mArchServiceSystem.mHttpEntityParser;
        this.mRouterType       = routerType;
    }

    public ArchServiceSystem getServiceSystem(){
        return this.mArchServiceSystem;
    }
    ...
    public void afterConnectionAccepted( Connectiom connectiom ) throws ServletException, IOException {
        connectiom.response.setCharacterEncoding( this.mArchServiceSystem.getServerCharset() );
    }
    ...
    public void jspTPLRenderPage( String szTemplatePath ) throws IOException, ServletException {
        this.mConnection.getRequest().getRequestDispatcher( this.mArchServiceSystem.getRealTemplatePath() + szTemplatePath ).forward(this.mConnection.getRequest(), this.mConnection.getResponse());
    }
    ...
    public void traceSystemErrorMsg( String szTitle, String szErrorMsg ) throws IOException, ServletException {
        ...
        this.jspRenderPage( this.mArchServiceSystem.getDefaultErrorPagePath() );
    }
    ...
    public void requestReceived() throws ServletException, IOException {
        try {
            this.mszWizardCommand = this.mConnection.$_GET().getString(this.mArchServiceSystem.getWizardParameter());
        } catch (JSONException e){ this.mszWizardCommand = ""; }
        try {
            this.mszModelCommand = this.mConnection.$_GET().getString(this.mArchServiceSystem.getModelParameter());
        } catch (JSONException e){ this.mszModelCommand = ""; }
        try {
            this.mszControlCommand = this.mConnection.$_GET().getString(this.mArchServiceSystem.getControlParameter());
        }
        catch (JSONException e){ this.mszControlCommand = ""; }

        this.mWizardSummoner   = SystemSpawner.spawnWizardSummoner( this.mArchServiceSystem.getWizardSummonerConfig(), this.mConnection );
    }
    ...
    protected void summonByRouterPath() throws ServletException, IOException {
        Object routum = this.mArchServiceSystem.getPrimeRouterDispatcher().queryRoutum( this.mszURI );
        if( routum != null ) {
