...
public abstract class ArchWizardum extends ArchWizard implements Wizardum {
    ...
    public void afterGetArrived( ArchServiceSystem system, HttpServletRequest request, HttpServletResponse response ){
        this.mParentSystem = system;
        this.afterGetArrived( request, response );
    }

    public void afterGetArrived( HttpServletRequest request, HttpServletResponse response ){
        this.afterSessionArrived( new GetConnection(
                new ArchConnectDispatcher( this.mParentSystem, RouterType.QueryString ), new Connectiom( request, response, null  )
        ) );
    }

    public void afterPostArrived( ArchServiceSystem system, HttpServletRequest request, HttpServletResponse response ){
        this.mParentSystem = system;
        this.afterPostArrived( request, response );
    }

    public void afterPostArrived( HttpServletRequest request, HttpServletResponse response ){
        this.afterSessionArrived( new PostConnection(
                new ArchConnectDispatcher( this.mParentSystem, RouterType.QueryString ), new Connectiom( request, response, null  )
        ) );
    }
    ...
    public ArchServiceSystem system(){
