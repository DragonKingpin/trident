<%@ page import="com.sauron.saurye.system.prototype.PredatorProto" %>
<%@ page import="com.pinecone.framework.util.json.JSONObject" %>
<%@ page import="com.pinecone.framework.util.json.JSONArray" %>
<%@ page import="com.sauron.saurye.system.PredatorArchWizardum" %>
