...
public class CurrencyTemplate {
    ...
    private final JSONObject mhDefaultFileCSSStyle = new JSONMaptron("{\"color\":\"#1E88C7\",\"background\":\"#D0EEFF\",\"font-size\":\"16px\",\"padding\":\"6px 12px\",\"border\":\"1px solid #99D3F5\",\"border-radius\":\"4px\",\"line-height\":\"20px\"}");
    ...
    public String spawnPredatorPictureMultipleExplorer(String szTableName,String szName,int nSize){
        try {
            ...
            if( szImageURL != null ) {
                ...
                JSONArray hURLArray = new JSONArraytron( szImageURL );
