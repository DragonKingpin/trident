package com.sauron.saurye.elements.mutual.Sentence;
...
public class SentenceLogicTree extends EpitomeSharded implements EpitomeCrystal {
    ...
    public JSONArray arterify() {
        ...
        this.mArtery = new JSONArraytron();
    ...
    public JSONArray tag( ) {
        return new JSONArraytron( this.tag0() );
    }

    public JSONArray tag_pine( ) {
        return new JSONArraytron( this.owned().getMaster().host().textBasicProcessor().getPinePoSs( this.tag0() ) );
    }

    public JSONArray tag_pine_detail( ) {
        return new JSONArraytron( this.owned().getMaster().host().textBasicProcessor().getPineDetailPoSs( this.tag0() ) );
    }
    ...
    public JSONArray keyWordify( boolean bUserSensitive ) throws SQLException {
        ...
        this.mKeyArtery = new JSONArraytron();
